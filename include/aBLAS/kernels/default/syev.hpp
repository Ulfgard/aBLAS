 ...
 * 
 *
 * \brief       Default implementation for the SYEV routine
 *
 * \author      O. Krause
 * \date        2015
 *
 ...
 *
 */
#ifndef ABLAS_KERNELS_DEFAULT_SYEV_HPP
#define ABLAS_KERNELS_DEFAULT_SYEV_HPP
...
void eigensort
(
	matrix_expression<MatrA,cpu_tag>& matA,
...
template <typename MatrA, typename VectorB>
void syev(
	matrix_expression<MatrA,cpu_tag>& vmatA,
	vector_expression<VectorB,cpu_tag>& dvecA
) {
