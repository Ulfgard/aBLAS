 ...
 * 
 *
 * \brief       Default implementation for the DOT routine
 *
 * \author      O. Krause
 * \date        2015
 *
 ...
 *
 */
#ifndef ABLAS_KERNELS_DEFAULT_DOT_HPP
#define ABLAS_KERNELS_DEFAULT_DOT_HPP
...
void dot(
	...
	ABLAS_SIZE_CHECK(v1().size()==v2().size());
