 ...
 * 
 *
 * \brief       Dispatcher for the POTRF routine
 *
 * \author      O. Krause
 * \date        2015
 *
 ...
 *
 */
#ifndef ABLAS_KERNELS_POTRF_HPP
#define ABLAS_KERNELS_POTRF_HPP

#ifdef ABLAS_USE_ATLAS_LAPACK
...
std::size_t potrf(
	...
	ABLAS_SIZE_CHECK(A().size1() == A().size2());
